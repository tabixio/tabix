...
ace.define('ace/mode/clickhouse', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text',
    ...
    let ClickhouseHighlightRules = null;
    let ClickhouseFoldMode = null;
    let MatchingBraceOutdent = null;
    let CstyleBehaviour = null;
    try {

        ClickhouseHighlightRules = require('./clickhouse_highlight_rules').ClickhouseHighlightRules;
        ClickhouseFoldMode = require('./clickhouse_FoldMode').FoldMode;
        ...
        console.warn('ace/mode/clickhouse',e);
    }
