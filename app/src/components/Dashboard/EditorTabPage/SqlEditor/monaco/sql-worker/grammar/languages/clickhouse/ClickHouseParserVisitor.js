...
export default class ClickHouseParserVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitTableColumnPropertyType(ctx) {
	  return this.visitChildren(ctx);
	}
